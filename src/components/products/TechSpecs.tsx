...
const TechSpecs = ({ headline, description, specs }: TechSpecsProps) => {
  return (
    <section id="tech-specs" className="py-24 lg:py-32">
      {/* Banner Headline */}
      <motion.h2
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {specs.map((spec, index) => (
          ...
          >
            ...
            {spec.description && (
              <span className="text-sm text-muted-foreground mt-1 transition-colors duration-300 group-hover:text-tempo-navy/70">
                {spec.description}
              </span>
            )}
          </motion.div>
