          ...
          {athletes.map((athlete, index) => (
            <motion.div
              ...
              className={`grid grid-cols-1 lg:grid-cols-2 gap-12 py-16 ${
                index !== athletes.length - 1 ? 'border-b border-border' : ''
              }`}
            >
              {/* Image */}
              <div className={`aspect-[4/5] bg-tempo-mist flex items-center justify-center ${
              ...
              <div className={`flex flex-col justify-center ${
                ...
                <p className="text-muted-foreground mb-8">{athlete.title}</p>
        ...
        <div className="max-w-[1400px] mx-auto text-center">
          ...
          <motion.a
            ...
            className="inline-block bg-tempo-bone text-tempo-carbon px-10 py-4 
                     ...
                     hover:bg-tempo-navy hover:text-tempo-bone transition-colors duration-300"
          >
            Apply Now
          </motion.a>
        </div>
